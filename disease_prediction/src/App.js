          ...
          <div className="container flex">
            ...
            <div className="navbar-collapse bg-white">
              ...
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <a href="http://127.0.0.1:5000/" className="nav-link">Tumor Detection</a>
                </li>
                <li className="nav-item">
          ...
          <div class = "container">
                ...
                <div class = "services-inner text-center grid">
                    <article class = "service-item">
                        ...
                        <p class = "text text-sm leading-9">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis possimus doloribus facilis velit, assumenda tempora quas mollitia quos voluptatibus consequatur!</p>
                    </article>
